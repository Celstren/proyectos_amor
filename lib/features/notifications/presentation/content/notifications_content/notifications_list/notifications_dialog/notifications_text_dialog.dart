...
class NotificationsTextDialog extends StatelessWidget {
  final String timeAgo;
  final String title;
  final String subTitle;
  final String description;
  const NotificationsTextDialog({
    super.key,
    this.timeAgo = '',
    this.title = '',
    this.subTitle = '',
...
void showNotificationsTextDialog(
  ...
  showDialog(
    context: context,
    builder: (context) => NotificationsTextDialog(
      timeAgo: timeAgo,
      title: title,
      subTitle: subTitle,
