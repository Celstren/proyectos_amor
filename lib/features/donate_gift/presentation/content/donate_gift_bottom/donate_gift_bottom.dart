...
class DonateGiftBottom extends StatelessWidget {
  final VoidCallback? onNext;
  final VoidCallback? onDone;
  const DonateGiftBottom({super.key, this.onNext, this.onDone});
      ...
      return Padding(
        ...
        child: GestureDetector(
          ...
          child: Row(
            ...
            children: <Widget>[
              const AppText.bold(
                DonateGiftStrings.donateGiftBottomNext,
                fontSize: 16,
    ...
    if (onDone != null) {
      return Padding(
        ...
        child: SizedBox(
          width: 180,
          child: AppButton(
            text: DonateGiftStrings.donateGiftBottomDone,
            onTap: onDone,
            radius: 50,
            color: ColorsConstant.primaryColor,
          ),
