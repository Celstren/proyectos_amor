...
class CreateAccountPersonal extends StatelessWidget {
  const CreateAccountPersonal({super.key});
      ...
      child: Column(
        ...
        children: <Widget>[
          const AppRichText(
            ...
            secondaryText:
                ' ${CreateAccountStrings.createAccountPersonalTitle2}',
          ...
          AppLabeledTextField(
            ...
            label: CreateAccountStrings.createAccountPersonalFirstNameLabel,
            hint: CreateAccountStrings.createAccountPersonalFirstNameHint,
          ),
          const SizedBox(height: SizeConstants.xl),
          AppLabeledTextField(
            controller: signUpBloc.lastNameController,
            label: CreateAccountStrings.createAccountPersonalLastNameLabel,
            hint: CreateAccountStrings.createAccountPersonalLastNameHint,
          ),
          const SizedBox(height: SizeConstants.xl),
          AppLabeledTextField(
          ...
          Padding(
            ...
            child: CreateAccountBottom(
              ...
              onNext: () => context
                  .read<ChangeCreateAccountStepCubit>()
                  .change(CreateAccountStep.password),
            ),
          ),
        ],
      ),
