...
import 'package:proyectos_amor/features/claim_certification/presentation/claim_certification_images.dart';

class ClaimCertificationHeader extends StatelessWidget {
  const ClaimCertificationHeader({super.key});
    ...
    return Column(
      ...
      children: <Widget>[
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              const AppText.semiBold(
                ClaimCertificationStrings.claimCertificationHeaderTitle,
                fontSize: 20,
        ...
        const AppImage.assetImage(
          size: 160,
          asset: ClaimCertificationImages.claimCertificationHeaderPlaceholder,
          fit: BoxFit.cover,
        ),
      ],
    );
