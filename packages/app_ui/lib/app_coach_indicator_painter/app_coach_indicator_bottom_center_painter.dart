...
class AppCoachIndicatorBottomCenterPainter extends CustomPainter {
  final Color color;
  final double radius;
  final double triangleSide;

  AppCoachIndicatorBottomCenterPainter({this.color = Colors.white, this.radius = 8, this.triangleSide = 15});
  ...
  @override
  bool shouldRepaint(AppCoachIndicatorBottomCenterPainter oldDelegate) => true;
}
